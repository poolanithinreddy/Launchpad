    ...
    <main className="flex min-h-screen items-center justify-center px-4 py-10">
      <Card className="w-full max-w-md border border-slate-200 bg-white shadow-none">
        <CardHeader className="space-y-4 text-center">
          <div className="mx-auto flex h-12 w-12 items-center justify-center rounded-2xl border border-slate-200 bg-slate-50 text-lg font-semibold text-slate-900">
            L
          </div>
        ...
        <CardContent className="space-y-5">
          ...
          <p className="text-center text-sm text-slate-500">
            GitHub is the only auth provider in Phase 1.
          </p>
        </CardContent>
      </Card>
    </main>
